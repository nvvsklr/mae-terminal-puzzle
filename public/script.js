class MaeTerminal {
    ...
    initializeSocketEvents() {
        ...
        // Mae responses
        this.socket.on('mae-response', (data) => {
            this.displayMaeMessage(data);
        ...
        this.socket.on('mae-typing', (data) => {
    ...
    handleTypingIndicator(isTyping) {
        ...
        if (isTyping) {
            ...
            typingDiv.className = 'message mae typing-indicator';
            
            typingDiv.innerHTML = '<span class="typing-dots">Mae is typing...</span>';
    ...
    handleDisconnect() {
        ...
        this.userInput.placeholder = 'Connection terminated...';
        
        // Add terminal effect
        const terminal = document.getElementById('terminal');
        terminal.classList.add('connection-lost');
        
        console.log('🔌 Mae has disconnected');
    }
}
